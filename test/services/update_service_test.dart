  ...
  group('Plezy Labs release parsing', () {
    test('selects the newest published Labs release and keeps its notes', () {
      final release = UpdateService.latestLabsReleaseFromJson([
        ...
        {'tag_name': 'labs-v2.8.0-r1', 'html_url': 'https://example.test/r1', 'draft': false, 'prerelease': false},
      ]);
    ...
    test('ignores drafts, Labs prereleases, and unrelated stable releases', () {
      final release = UpdateService.latestLabsReleaseFromJson([
        {'tag_name': 'labs-v2.8.0-r3', 'html_url': 'https://example.test/draft', 'draft': true, 'prerelease': false},
        {
          'tag_name': 'labs-v2.8.0-r2',
        ...
        {'tag_name': 'beta-v2.8.0', 'html_url': 'https://example.test/beta', 'draft': false, 'prerelease': false},
      ]);
