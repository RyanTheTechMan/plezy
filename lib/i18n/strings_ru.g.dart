...
class _Translations$explore$ru extends Translations$explore$en {
	...
	@override late final _Translations$explore$ratingSource$ru ratingSource = _Translations$explore$ratingSource$ru._(_root);
...
class _Translations$explore$ratingSource$ru extends Translations$explore$ratingSource$en {
	_Translations$explore$ratingSource$ru._(TranslationsRu root) : this._root = root, super.internal(root);
...
extension on TranslationsRu {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'explore.stats.comments' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ru'))(n, one: '${n} comment', other: '${n} comments', ), 
			...
			'explore.detail.recommendedByUsers' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ru'))(n, one: 'Recommended by ${n} user', other: 'Recommended by ${n} users', ), 
			...
			'explore.totalResults' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ru'))(n, one: '${n} result', other: '${n} results', ), 
