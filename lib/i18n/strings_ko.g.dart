...
class _Translations$explore$ko extends Translations$explore$en {
	...
	@override late final _Translations$explore$ratingSource$ko ratingSource = _Translations$explore$ratingSource$ko._(_root);
...
class _Translations$explore$ratingSource$ko extends Translations$explore$ratingSource$en {
	_Translations$explore$ratingSource$ko._(TranslationsKo root) : this._root = root, super.internal(root);
...
extension on TranslationsKo {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'explore.stats.comments' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ko'))(n, one: '${n} comment', other: '${n} comments', ), 
			...
			'explore.detail.recommendedByUsers' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ko'))(n, one: 'Recommended by ${n} user', other: 'Recommended by ${n} users', ), 
			...
			'explore.totalResults' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('ko'))(n, one: '${n} result', other: '${n} results', ), 
