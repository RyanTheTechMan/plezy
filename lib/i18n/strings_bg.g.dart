...
class _Translations$explore$bg extends Translations$explore$en {
	...
	@override late final _Translations$explore$ratingSource$bg ratingSource = _Translations$explore$ratingSource$bg._(_root);
...
class _Translations$explore$ratingSource$bg extends Translations$explore$ratingSource$en {
	_Translations$explore$ratingSource$bg._(TranslationsBg root) : this._root = root, super.internal(root);
...
extension on TranslationsBg {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'explore.stats.comments' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('bg'))(n, one: '${n} comment', other: '${n} comments', ), 
			...
			'explore.detail.recommendedByUsers' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('bg'))(n, one: 'Recommended by ${n} user', other: 'Recommended by ${n} users', ), 
			...
			'explore.totalResults' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('bg'))(n, one: '${n} result', other: '${n} results', ), 
