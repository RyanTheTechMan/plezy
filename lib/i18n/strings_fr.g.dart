...
class _Translations$explore$fr extends Translations$explore$en {
	...
	@override late final _Translations$explore$ratingSource$fr ratingSource = _Translations$explore$ratingSource$fr._(_root);
...
class _Translations$explore$ratingSource$fr extends Translations$explore$ratingSource$en {
	_Translations$explore$ratingSource$fr._(TranslationsFr root) : this._root = root, super.internal(root);
...
extension on TranslationsFr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'explore.stats.comments' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('fr'))(n, one: '${n} comment', other: '${n} comments', ), 
			...
			'explore.detail.recommendedByUsers' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('fr'))(n, one: 'Recommended by ${n} user', other: 'Recommended by ${n} users', ), 
			...
			'explore.totalResults' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('fr'))(n, one: '${n} result', other: '${n} results', ), 
