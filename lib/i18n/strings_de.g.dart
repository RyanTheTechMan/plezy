...
class _Translations$explore$de extends Translations$explore$en {
	...
	@override late final _Translations$explore$ratingSource$de ratingSource = _Translations$explore$ratingSource$de._(_root);
...
class _Translations$explore$ratingSource$de extends Translations$explore$ratingSource$en {
	_Translations$explore$ratingSource$de._(TranslationsDe root) : this._root = root, super.internal(root);
...
extension on TranslationsDe {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'explore.stats.comments' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('de'))(n, one: '${n} comment', other: '${n} comments', ), 
			...
			'explore.detail.recommendedByUsers' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('de'))(n, one: 'Recommended by ${n} user', other: 'Recommended by ${n} users', ), 
			...
			'explore.totalResults' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('de'))(n, one: '${n} result', other: '${n} results', ), 
