...
class _Translations$explore$it extends Translations$explore$en {
	...
	@override late final _Translations$explore$ratingSource$it ratingSource = _Translations$explore$ratingSource$it._(_root);
...
class _Translations$explore$ratingSource$it extends Translations$explore$ratingSource$en {
	_Translations$explore$ratingSource$it._(TranslationsIt root) : this._root = root, super.internal(root);
...
extension on TranslationsIt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'explore.stats.comments' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('it'))(n, one: '${n} comment', other: '${n} comments', ), 
			...
			'explore.detail.recommendedByUsers' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('it'))(n, one: 'Recommended by ${n} user', other: 'Recommended by ${n} users', ), 
			...
			'explore.totalResults' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('it'))(n, one: '${n} result', other: '${n} results', ), 
