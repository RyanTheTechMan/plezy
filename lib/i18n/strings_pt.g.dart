...
class _Translations$explore$pt extends Translations$explore$en {
	...
	@override late final _Translations$explore$ratingSource$pt ratingSource = _Translations$explore$ratingSource$pt._(_root);
...
class _Translations$explore$ratingSource$pt extends Translations$explore$ratingSource$en {
	_Translations$explore$ratingSource$pt._(TranslationsPt root) : this._root = root, super.internal(root);
...
extension on TranslationsPt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'explore.stats.comments' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('pt'))(n, one: '${n} comment', other: '${n} comments', ), 
			...
			'explore.detail.recommendedByUsers' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('pt'))(n, one: 'Recommended by ${n} user', other: 'Recommended by ${n} users', ), 
			...
			'explore.totalResults' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('pt'))(n, one: '${n} result', other: '${n} results', ), 
