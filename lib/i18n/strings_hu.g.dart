...
class _Translations$explore$hu extends Translations$explore$en {
	...
	@override late final _Translations$explore$ratingSource$hu ratingSource = _Translations$explore$ratingSource$hu._(_root);
...
class _Translations$explore$ratingSource$hu extends Translations$explore$ratingSource$en {
	_Translations$explore$ratingSource$hu._(TranslationsHu root) : this._root = root, super.internal(root);
...
extension on TranslationsHu {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'explore.stats.comments' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('hu'))(n, one: '${n} comment', other: '${n} comments', ), 
			...
			'explore.detail.recommendedByUsers' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('hu'))(n, one: 'Recommended by ${n} user', other: 'Recommended by ${n} users', ), 
			...
			'explore.totalResults' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('hu'))(n, one: '${n} result', other: '${n} results', ), 
