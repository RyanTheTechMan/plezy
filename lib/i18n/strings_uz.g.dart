...
class _Translations$explore$uz extends Translations$explore$en {
	...
	@override late final _Translations$explore$ratingSource$uz ratingSource = _Translations$explore$ratingSource$uz._(_root);
...
class _Translations$explore$ratingSource$uz extends Translations$explore$ratingSource$en {
	_Translations$explore$ratingSource$uz._(TranslationsUz root) : this._root = root, super.internal(root);
...
extension on TranslationsUz {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'explore.stats.comments' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('uz'))(n, one: '${n} comment', other: '${n} comments', ), 
			...
			'explore.detail.recommendedByUsers' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('uz'))(n, one: 'Recommended by ${n} user', other: 'Recommended by ${n} users', ), 
			...
			'explore.totalResults' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('uz'))(n, one: '${n} result', other: '${n} results', ), 
