...
class _Translations$explore$da extends Translations$explore$en {
	...
	@override late final _Translations$explore$ratingSource$da ratingSource = _Translations$explore$ratingSource$da._(_root);
...
class _Translations$explore$ratingSource$da extends Translations$explore$ratingSource$en {
	_Translations$explore$ratingSource$da._(TranslationsDa root) : this._root = root, super.internal(root);
...
extension on TranslationsDa {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'explore.stats.comments' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('da'))(n, one: '${n} comment', other: '${n} comments', ), 
			...
			'explore.detail.recommendedByUsers' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('da'))(n, one: 'Recommended by ${n} user', other: 'Recommended by ${n} users', ), 
			...
			'explore.totalResults' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('da'))(n, one: '${n} result', other: '${n} results', ), 
