...
class _Translations$explore$nl extends Translations$explore$en {
	...
	@override late final _Translations$explore$ratingSource$nl ratingSource = _Translations$explore$ratingSource$nl._(_root);
...
class _Translations$explore$ratingSource$nl extends Translations$explore$ratingSource$en {
	_Translations$explore$ratingSource$nl._(TranslationsNl root) : this._root = root, super.internal(root);
...
extension on TranslationsNl {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'explore.stats.comments' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('nl'))(n, one: '${n} comment', other: '${n} comments', ), 
			...
			'explore.detail.recommendedByUsers' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('nl'))(n, one: 'Recommended by ${n} user', other: 'Recommended by ${n} users', ), 
			...
			'explore.totalResults' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('nl'))(n, one: '${n} result', other: '${n} results', ), 
