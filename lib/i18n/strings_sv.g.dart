...
class _Translations$explore$sv extends Translations$explore$en {
	...
	@override late final _Translations$explore$ratingSource$sv ratingSource = _Translations$explore$ratingSource$sv._(_root);
...
class _Translations$explore$ratingSource$sv extends Translations$explore$ratingSource$en {
	_Translations$explore$ratingSource$sv._(TranslationsSv root) : this._root = root, super.internal(root);
...
extension on TranslationsSv {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'explore.stats.comments' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('sv'))(n, one: '${n} comment', other: '${n} comments', ), 
			...
			'explore.detail.recommendedByUsers' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('sv'))(n, one: 'Recommended by ${n} user', other: 'Recommended by ${n} users', ), 
			...
			'explore.totalResults' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('sv'))(n, one: '${n} result', other: '${n} results', ), 
