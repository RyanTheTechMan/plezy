...
class _Translations$explore$pl extends Translations$explore$en {
	...
	@override late final _Translations$explore$ratingSource$pl ratingSource = _Translations$explore$ratingSource$pl._(_root);
...
class _Translations$explore$ratingSource$pl extends Translations$explore$ratingSource$en {
	_Translations$explore$ratingSource$pl._(TranslationsPl root) : this._root = root, super.internal(root);
...
extension on TranslationsPl {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'explore.stats.comments' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('pl'))(n, one: '${n} comment', other: '${n} comments', ), 
			...
			'explore.detail.recommendedByUsers' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('pl'))(n, one: 'Recommended by ${n} user', other: 'Recommended by ${n} users', ), 
			...
			'explore.totalResults' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('pl'))(n, one: '${n} result', other: '${n} results', ), 
